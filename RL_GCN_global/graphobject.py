...
class GraphEnv(gym.Env):
    def __init__(self):
        self.num_node = 10  #number of node in graph
        self.action_space = 10 #action is devided to two steps: starting node
        ...
        self.low_eigenvalue = 4
        self.high_eigenvalue = 10.8
